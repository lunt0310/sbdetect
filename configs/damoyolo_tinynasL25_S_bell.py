...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = str(project_root / "workdir" / "damoyolo_tinynasL25_Car")
        ...
        self.dataset.train_ann = ('car_train_coco', )
        self.dataset.val_ann = ('car_val_coco', )
        ...
        self.dataset.class_names = ['car', 'car_num']
